...
<head>
    ...
    <!--FontAwesome CSS-->
    <script src="https://kit.fontawesome.com/a6872dc6cd.js" crossorigin="anonymous"></script>
    <!-- daisy ui -->
...
<body>
    ...
    <button onclick="topFunction()" id="back-to-top"
        class="fixed rounded z-10 bottom-5 end-5 btn-accent btn btn-sm hover:scale-105">
