<div>
    <section class="breadcrumbs relative pb-0">
        ...
        <div class="py-16 lg:py-28 text-center relative">
            <h2 class="text-accent uppercase text-2xl font-semibold tracking-wide lg:text-4xl">Visiting</h2>
        </div>
    </section>
        ...
        <div class="px-2 lg:px-5">
            <div class="flex gap-2 flex-wrap justify-between w-full items-end">
                <div class="w-full max-w-xl pb-2">
                    <p class="mb-1 text-[#008068]">Welcome to the Magnificent Venue</p>
                    <h2 class="mb-1 text-3xl font-extrabold tracking-wide">Bali, indonesia</h2>
                    <p class="m-0 text-justify"><span class="text-[#008068]">Bali</span> has
                ...
                <div class="">
                    <a class="text-sm underline hover:text-[#008068]" href="javascript:void(0)">See more story of Bali
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 mt-5">
                ...
                <div class="w-full font-normal px-5">
                    ...
                    <div class="flex justify-between p-2">
                        <button class="font-semibold hover:text-[#008068] hover:cursor-pointer hover:underline">Visa
                            Regulation</button><i class="fa fa-arrows-up-down"></i>
                        <button onclick="flight.showModal()"
                            class="font-semibold hover:text-[#008068] hover:cursor-pointer hover:underline">Flight time
                            to Bali </button><i class="fa fa-arrows-up-down"></i>
                        <button onclick="electric.showModal()"
                            class="font-semibold hover:text-[#008068] hover:cursor-pointer hover:underline">Electric
                            Current </button><i class="fa fa-arrows-up-down"></i>
                        <a href="#bndcc"
                            class="font-semibold hover:text-[#008068] hover:cursor-pointer hover:underline">Conference
                            Venue </a>
                    </div>
            ...
            <div class="pt-10 lg:pt-20">
                <h4 class="text-xl font-semibold tracking-wide text-[#008068] mb-5">Top Reasons to Visit Bali</h4>
                <!-- name of each tab group should be unique -->
                <div class="tabs tabs-border justify-center gap-3 text-gray-500">
                    <input type="radio" name="my_tabs_2" class="tab hover:text-[#008068] text-[#78c9bb]"
            ...
            this.autoplayTimer = null;
                                    ...
                                    <div id="slide1"
                                        ...
                                        <div class="absolute left-5 right-5 top-1/2 flex -translate-y-1/2 transform justify-between">
                                            <button wire:click="previousSlide" class="btn btn-circle btn-success btn-outline">❮</button>
                                            <button wire:click="nextSlide" class="btn btn-circle btn-success btn-outline">❯</button>
                                        </div>
                                    </div>
    ...
    <section id="bndcc" class="px-5 md:px-10 py-10 md:py-20" id="venue">
        <div class="px-2 lg:px-5">
            <p class="mb-1 text-[#008068]">Conference Venue</p>
