<div>
    <section class="breadcrumbs relative pb-0">
        ...
        <div class="py-16 lg:py-28 text-center relative">
            <h2 class="text-accent uppercase text-2xl font-semibold tracking-wide lg:text-4xl">Abstract Submission</h2>
        </div>
    </section>

    <section class="bg-base-100 px-5 md:px-10 pt-0 pb-10 md:py-20">
        <div class="text-center lg:text-start mb-5 md:mb-10">
            <p class="mb-1 text-accent">Submission</p>
            <h2 class="mb-2 uppercase text-3xl font-semibold">Guideline for <span class="text-[#008068]">Abstract
                    Submission</span>
            </h2>
    ...
    <section class="bg-base-100 px-5 md:px-10 py-10 md:py-20">
        <div class="text-center lg:text-start mb-5 md:mb-10">
            <p class="mb-1 text-accent">Submission</p>
            <h2 class="mb-2 uppercase text-3xl font-semibold">Educative flyer and educative video <span class="text-[#008068]">Competition</span>
            </h2>
        </div>
        <div class="flex flex-col md:flex-row justify-between gap-5 md:gap-0">
            <div class="order-2 w-full max-w-md">
                <div class="card bg-base-200 w-full shadow-sm rounded-lg">
                    <div class="card-body">
                        <h2 class="card-title">Upload <span class="text-[#008068]">Video & Flyer</span></h2>
