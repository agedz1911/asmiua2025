...
<<<<<<< HEAD
            <h2 class="text-accent uppercase text-2xl font-semibold tracking-wide lg:text-4xl">Scientific Program</h2>
=======
            <h2 class="text-accent uppercase text-2xl font-semibold tracking-wide lg:text-4xl">Scientific Schedule</h2>
...
<<<<<<< HEAD
        <label class="input input-accent input-lg w-full">
=======
    ...
    <section class="pt-10 pb-24 px-2 lg:px-5">
        <div class="flex flex-col lg:flex-row justify-between gap-4">
            ...
            <div class="w-full lg:w-3/4 order-2 lg:order-1">
                @foreach ($uniqDates as $date)
                <div class="text-center lg:text-start border-t border-dashed pt-2">
                    <h2 class="text-lg font-semibold uppercase text-accent tracking-wider">
                        {{\Carbon\Carbon::parse($date)->format('l, d F')}}
                    </h2>
                </div>
                @foreach ($uniqCategories as $item)
                @if (
                !($date == '2026-10-1' && ($item == 'Symposium' || $item == 'Master Class' || $item == 'Scientific Competition')) &&
                !($date == '2026-10-2' && ($item == 'Symposium' || $item == 'Master Class' || $item == 'Scientific Competition')) &&
                !($date == '2026-10-3' && ($item == 'Workshop' || $item == 'Master Class' || $item == 'Scientific Competition'))
                )
                <p class="font-semibold tracking-wider my-5"><i
