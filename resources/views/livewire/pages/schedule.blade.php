    ...
    <section class="pt-10 pb-24 px-2 lg:px-5">
        <div class="flex flex-col lg:flex-row justify-between gap-4">
            ...
            <div class="w-full lg:w-3/4 order-2 lg:order-1">
                ...
                @foreach ($uniqCategories as $item)
                @if (
                !($date == '2026-10-1' && ($item == 'Symposium' || $item == 'Master Class' || $item == 'Scientific
                Competition')) &&
                !($date == '2026-10-2' && ($item == 'Symposium' || $item == 'Master Class' || $item == 'Scientific
                Competition')) &&
                !($date == '2026-10-3' && ($item == 'Workshop' || $item == 'Master Class' || $item == 'Scientific
                Competition'))
                )
